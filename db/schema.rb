...
ActiveRecord::Schema.define(version: 2022_05_19_032849) do
  ...
  create_table "destinations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_order_id"], name: "index_destinations_on_purchase_order_id"
  end
  ...
  add_foreign_key "destinations", "purchase_orders"
